    ...
    <>
      ...
      >
        <div className="relative z-10 text-white flex justify-center items-center flex-col h-screen">
          <h1 className="font-bold text-clamp text-center whitespace-nowrap">
            OLATUNBOSUN OLASHUBOMI
          </h1>
          <span className="font-serif my-3">SOFTWARE ENGINEER</span>
          <button className="mt-4 py-2 px-12 text-xl font-semibold bg-slate-900">
            Contact Me
          </button>
        </div>
        <span className="absolute left-0 bottom-16 bg-slate-800 text-white text-2xl p-1">
          <MdOutlineArrowRight />
        </span>
      </section>
      <section className="flex justify-center gap-20 items-center min-h-[90vh] max-[1037px]:flex-col max-[1037px]:p-36 max-[1037px]:px-8 bg-white">
        ...
        <div className="max-w-md max-[1037px]:max-w-full">
          ...
          <h2 className="text-3xl font-bold mt-2 mb-6">
            Olatunbosun is a Software Engineer based in Nigeria
          </h2>
          <p className="text-base text-[#5e5e5e] leading-7 text-justify">
            I&apos;m passionate about technology and enjoys building innovative
            solutions using his extensive knowledge of programming languages. He
            has worked in various industries, including technology, finance, and
            healthcare, and has a strong foundation in computer science and
            programming.
          </p>
          <button className="mt-8 px-9 py-3 bg-slate-800 text-white">
            DOWNLOAD CV
          </button>
        </div>
      </section>
      <section className="min-h-[28vh] bg-slate-800 opacity-90 grid grid-cols-4 max-[1037px]:grid-cols-2 max-[747px]:grid-cols-1 gap-10 max-[1037px]:py-14 place-items-center">
        <div className="">
          <span className="text-white text-3xl font-bold text-center block mb-3">
            777
          </span>
        ...
        <div className="max-w-5xl w-full">
          ...
          <div className="mt-20 grid grid-cols-3 gap-10 max-[1037px]:grid-cols-2 max-[747px]:grid-cols-1">
            <div className="shadow-lg bg-white p-10 py-12 gap-4 flex flex-col group max-w-[270px] hover:bg-slate-900 transition-colors hover:text-white origin-top-left max-[1037px]:max-w-full">
              <span className="bg-slate-900 group-hover:bg-white w-20 h-20 flex justify-center items-center rounded-full group-hover:text-slate-900 text-white text-3xl">
                <SiMaterialdesignicons />
              </span>
              <h2 className="text-2xl font-bold mt-5">Creative Design</h2>
              <p className="leading-8 text-[#969292]">
                I create visually appealing and user-friendly designs for
                various projects.
              </p>
            </div>
            <div className="shadow-lg bg-white p-10 py-12 gap-4 flex flex-col max-w-[270px] max-[1037px]:max-w-full">
              <span className="bg-slate-900 w-20 h-20 flex justify-center items-center rounded-full text-white text-4xl">
                <MdDeveloperMode />
              </span>
              <h2 className="text-2xl font-bold mt-5">Web Development</h2>
              <p className="leading-8 text-[#969292]">
                I help you build websites that are user-friendly, responsive,
                and SEO-friendly.
              </p>
            </div>
            <div className="shadow-lg bg-white p-10 py-12 gap-4 flex flex-col max-w-[270px] max-[1037px]:max-w-full">
              <span className="bg-slate-900 w-20 h-20 flex justify-center items-center rounded-full text-white text-5xl">
                <IoMdApps />
              </span>
              <h2 className="text-2xl font-bold mt-5">App Development</h2>
              <p className="leading-8 text-[#969292]">
                I help you build mobile apps that are user-friendly, responsive,
                and optimized for both iOS and Android.
              </p>
            </div>
            <div className="shadow-lg bg-white p-10 py-12 gap-4 flex flex-col max-w-[270px] max-[1037px]:max-w-full">
              <span className="bg-slate-900 w-20 h-20 flex justify-center items-center rounded-full text-white text-3xl">
                <TiVideo />
              </span>
              <h2 className="text-2xl font-bold mt-5">Video Editing</h2>
              <p className="leading-8 text-[#969292]">
                I help you create engaging and visually appealing videos that
            ...
            <div className="shadow-lg bg-white p-10 py-12 gap-4 flex flex-col max-w-[270px] max-[1037px]:max-w-full">
              ...
              <p className="leading-8 text-[#969292]">
                I help you create memorable and engaging branding materials that
            ...
            <div className="shadow-lg bg-white p-10 py-12 gap-4 flex flex-col max-w-[270px] max-[1037px]:max-w-full">
              ...
              <p className="leading-8 text-[#969292]">
                I help you create visually appealing and user-friendly designs
          ...
          <div className="mt-20 grid grid-cols-2 max-[1037px]:grid-cols-1 gap-10">
            <div className="">
              ...
              <div className="grid grid-cols-2 max-[747px]:grid-cols-1 gap-4">
                <div className="py-3 px-8 bg-slate-200 text-[#333] max-w-[200px] max-[1037px]:max-w-full uppercase font-medium">
                  Html - 85%
                </div>
                <div className="py-3 px-8 bg-slate-200 text-[#333] max-w-[200px] max-[1037px]:max-w-full uppercase font-medium">
                  Css - 85%
            ...
            <div className="">
              ...
              <div className="grid grid-cols-2 gap-4 max-[747px]:grid-cols-1">
                <div className="py-3 px-8 bg-blue-100 text-[#333] max-w-[200px] max-[1037px]:max-w-full uppercase font-medium">
                  Mongodb - 85%
                </div>
                <div className="py-3 px-8 bg-blue-100 text-[#333] max-w-[200px] max-[1037px]:max-w-full uppercase font-medium">
                  Node - 85%
      ...
      <section className="bg-slate-900 h-[65vh] flex items-center flex-col">
        <div className="bg-black/10 -mt-14 mb-14 p-3 rounded-full">
          <div className="bg-blue-900 text-white w-24 rounded-full h-24 flex justify-center items-center text-4xl font-bold">
            <CiPlay1 />
          </div>
        </div>
        ...
        <p className="text-white text-center mt-10 hover:underline font-mono font">
          pshubomi@gmail.com
        </p>
        ...
        <div className="bg-white w-4/6 max-[1037px]:w-4/5 h-[300px] max-[653px]:w-[95%] mt-24 max-[653px]:p-4 flex justify-center flex-col items-center gap-8 -mb-24 shadow-md">
          ...
          <p className="max-[653px]:p-4 max-[653px]:text-center">
            Empowering 120,000+Businesses with Innovation{" "}
            <span className="text-blue-900">trusted clients</span>.
          </p>
        </div>
      </section>
        ...
        <div className="flex justify-center items-center gap-20 max-[1037px]:flex-col">
          <div className="max-w-md max-[1037px]:max-w-full">
            ...
            <p className="leading-9 text-[#969292] text-pretty">
              ...
              to show potential customers how valuable their products and
              services are. Testimonials are a short statement that describes
              how a product or service worked for a customer. Testimonials can
              help build trust and credibility with your customers.
            </p>
            <button className="mt-8 px-9 py-3 bg-slate-800 text-white">
              CONTACT ME
            </button>
          ...
          <div className="p-14 max-w-md shadow-lg max-[1037px]:max-w-full max-[645px]:p-5">
            <span className="items-center gap-1 text-lg mb-5 inline-flex">
              <CiStar />
              <CiStar />
              <CiStar />
              <CiStar />
            ...
            <p>
              Wonderful support. Immediate response and they return with and
              easy fix and clear information. Applied the fix and worked like a
              charm, you can definitely trust this developers!
            </p>
          ...
          <div className="mt-20 grid grid-cols-3 max-[1037px]:grid-cols-2 max-[747px]:grid-cols-1 gap-10">
            <div className="w-72 max-[1037px]:w-full shadow-md bg-white overflow-hidden">
              <div className="overflow-hidden">
                <Image
                  src={
                    "https://images.pexels.com/photos/28720925/pexels-photo-28720925/free-photo-of-minimalist-diagonal-stairway-against-white-wall.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
                  }
                  width={500}
                  height={500}
              ...
              <div className="p-8">
                <span className="text-[#969292] text-base">
                  Oct 26, 2023 in <span className="text-blue-900">Design</span>
                </span>
                <hr className="my-5" />
                <h2 className="text-2xl font-semibold">
                  Building Portfolio website with Vanilla
                </h2>
              </div>
            </div>
            <div className="w-72 max-[1037px]:w-full shadow-md bg-white overflow-hidden">
              <div className="overflow-hidden">
                <Image
                  src={
                    "https://images.pexels.com/photos/11931931/pexels-photo-11931931.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
                  }
                  width={500}
                  height={500}
                  alt="Testimonial Image"
          ...
          <div className="flex justify-center items-center max-[1037px]:items-start max-[1037px]:flex-col gap-20 mt-20">
            <div className="">
              <div className="flex items-center gap-4 mt-10">
                <span className="bg-slate-900 p-5 text-3xl text-white rounded-full">
                  <CiMail />
                </span>
                <div className="">
              ...
              <div className="flex items-center gap-4 mt-10">
                ...
                <div className="">
                  <span className="block text-[#767676] text-base">
                    Social:
                  </span>
                  <div className=" flex gap-4 text-3xl text-slate-900">
                    ...
                    <Link href="https://x.com/Derrick9923" target="_blank">
                      <FaXTwitter />
                    </Link>
                    <Link
                    ...
                    <Link
                      href="https://web.facebook.com/profile.php?id=100089629576598"
                      target="_blank"
                    >
                      <FaFacebook />
                    </Link>
            ...
            <form action="" className="max-[1037px]:w-full">
              <div className="flex gap-5">
                <input
                  type="text"
                  placeholder="Name"
                  className="border-2 py-4 text-lg px-3 max-[1037px]:w-full"
                />
                <input
                  type="text"
                  placeholder="Email"
              ...
              <textarea
                placeholder="Message"
                className="border-2 pt-4 text-lg w-full px-3 mt-5 h-36 resize-none"
              />
              <button className="mt-3 px-9 py-3 bg-slate-800 text-white w-full">
                SEND MESSAGE
              </button>
            </form>
          </div>
